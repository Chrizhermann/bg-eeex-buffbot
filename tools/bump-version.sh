...
echo "  5. gh release create v$NEW_VERSION --notes \"...\" --latest   # triggers packaging workflow"
echo ""
echo "IMPORTANT: NEVER pass --prerelease. All BuffBot releases (including -alpha) must"
echo "stay eligible to be 'Latest' on GitHub. If a release was accidentally marked"
echo "pre-release, fix with:  gh release edit v<tag> --prerelease=false --latest"
