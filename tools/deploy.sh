...
for f in M_BfBot.lua BfBotCor.lua BfBotThm.lua BfBotCls.lua BfBotScn.lua BfBotExe.lua BfBotMp.lua BfBotPer.lua BfBotInn.lua BfBotUI.lua BfBotTst.lua BuffBot.menu; do
    if [ ! -f "$SRC_DIR/$f" ]; then
